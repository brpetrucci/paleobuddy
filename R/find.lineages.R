...
#'
#' \code{find.lineages} finds and separates monophyletic clades from simulations
#' generated by \code{bd.sim} function. As a default, it finds the clades descended
...
#'
#' \code{find.lineage} takes a simulation object, usually from \code{bd.sim},
#' and a species number, and returns the simulation object that has that
#' species as a common ancestor.
#'
#' @param sim a simulation from the \code{bd.sim} function. The
