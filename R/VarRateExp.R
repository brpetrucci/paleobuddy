...
#'
#' @examples
#' Let's create a vector of times to use in these examples.
T <- seq(0, 50, 0.1)
#'
...
plot(T, div, type='l')
#' ote the delay in running VarRateExp using this method. Integrating a step
...
#'
#' while this works well it will be a pain to integrate.
