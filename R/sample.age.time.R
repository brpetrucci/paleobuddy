...
#' @examples
#' 
#' Please note the shape of the fossilization becomes easier to see when rho 
#' is very high (e.g., >100). We will not do this here due to CRAN constraints 
#' on example length, but users are encoraged to try. Histograms can be used 
#' to visualize the sampling though age, as we do here in the 2nd example 
#' (PERT function) - we will not do this is all examples because this page 
#' would be too long.
#'  
#'  # vector of times
#'  time <- seq(10, 0, -0.1)
...
#'                     tMax = 10, S = 1, md = 8)
#'  # note we are providing the peak for the triangular sampling as an 
#' argument. In this example, that peak is assigned in absolute geological 
#' time for the saking of demonstration that this option exists, but 
#' clearly in terms of age it makes more sense to express this in terms 
#' of age (a given percentile of the age, for instance)
#'  
#'  ###
...
#'  
#'  # age-dependence distribution, with the "peak" of the triangle
